...
public enum EnumUF {
     ...
     */
    EnumUF(final String nome, final String sigla, final String capital) {
      this.nome = nome;
      this.sigla = sigla;
     ...
     */
    public static EnumUF fromUF(final String nomeUf) {
      for (final EnumUF uf : EnumUF.values()) {
     ...
     */
    public static EnumUF fromSigla(final String sigla) {
      for (final EnumUF uf : EnumUF.values()) {
     ...
     */
    public static EnumUF fromCapital(final String capital) {
      for (final EnumUF uf : EnumUF.values()) {
    ...
    public static Vector<EnumUF> carregarUnidadesFederativas() {
        
        Vector<EnumUF> ufs = new Vector();
        
        ufs.addAll(Arrays.asList(EnumUF.values()));   
...
//      final StringBuilder sb = new StringBuilder("Unidade Federativa{");
